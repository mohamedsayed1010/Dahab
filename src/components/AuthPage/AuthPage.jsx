...
const ADMIN_PHONE = "01027070200";

// ================= NORMALIZE PHONE =================
const normalizePhone = (phone) => {
if (!phone) return phone;

// رقم الأدمن يتبعت كما هو
if (phone === ADMIN_PHONE) {
  return phone;
}

// أي مستخدم عادي يضاف له +20
  ...
  phone: Yup.string()
    ...
    .test(
      ...
      (value) => {
        ...
        // يمنع الأرقام كلها نفس الرقم
        if (/^(\d)\1+$/.test(value)) {
          return false;
        }

        // يمنع 01111111111 - 01222222222
